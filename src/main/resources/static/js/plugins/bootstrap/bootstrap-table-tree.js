...
(function ($) {
    ...
    BootstrapTable.prototype.expandRow_ = function (expand, index) {
        ...
        if ($tr.next().is('tr.detail-view') === (expand ? false : true)) {
            ...
            $tr.find('.tree-icon.tree-collapse').click();
        }
    };
    ...
    function __expandAll(){
        if($('.tree-icon.tree-collapse').length > 0){
            $('.tree-icon.tree-collapse').each(function () {
                if($(this).parents(".tree-indent").find("div").length < 3){
                    $(this).click();
                    __expandAll();
                }
            });
    ...
    var allowedMethods = [
        'getOptions',
        'getSelections', 'getAllSelections', 'getData','setData',
